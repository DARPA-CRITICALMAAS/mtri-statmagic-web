...
# res = cdr.get_model_run('a475db0fb3f34318ab4f65f05690f875')
# print(res)
# blerg
...
res = cdr.get_preprocess_event('502cda93ef5e4d249aa3aaaf27419792')
#print(res)
for i,r in enumerate(res):
    print(r)
    #print(i,r['download_url'])
...
print(res)
print(len(res['payload']['evidence_layers']))
